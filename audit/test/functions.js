...
addAccount(eth.accounts[3], "Account #3 - Precommitments");
addAccount(eth.accounts[4], "Account #4 - Precommitments");
...
function printTokenContractDetails() {
  ...
  if (tokenContractAddress != null && tokenContractAbi != null) {
    ...
    var tokensBoughtEvent = contract.TokensBought({}, { fromBlock: tokenFromBlock, toBlock: latestBlock });
    i = 0;
    tokensBoughtEvent.watch(function (error, result) {
      console.log("RESULT: TokensBought " + i++ + " #" + result.blockNumber + " buyer=" + result.args.buyer + 
        ...
        " participantTokenBalance=" + result.args.participantTokenBalance.shift(-decimals) + 
    ...
    var precommitmentAddedEvent = contract.PrecommitmentAdded({}, { fromBlock: tokenFromBlock, toBlock: latestBlock });
    i = 0;
    precommitmentAddedEvent.watch(function (error, result) {
      console.log("RESULT: PrecommitmentAdded " + i++ + " #" + result.blockNumber + " participant=" + result.args.participant + 
